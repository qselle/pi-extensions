...
The stack hides temporarily while the goal or plan modal is open and restores afterward unless the user hid it manually. Manual visibility resets for a new session or extension reload.
